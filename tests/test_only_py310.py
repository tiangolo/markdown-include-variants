...
def test_all_variants_plain():
    input_md = inspect.cleandoc(
        """
        {* docs_src/only_py310/tutorial001_an_py310.py *}
        """
    )
    ...
    assert result == snapshot(
        inspect.cleandoc(
            ...
            <p>//// tab | Python 3.10+
            <code>python
            {!docs_src/only_py310/tutorial001_an_py310.py!}</code></p>
            <p>////</p>
            <p>///// details | 🤓 Other versions and variants</p>
            <p>//// tab | Python 3.10+ - non-Annotated</p>
            <p>/// tip</p>
            <p>Prefer to use the <code>Annotated</code> version if possible.</p>
            <p>///</p>
            <p><code>python
            {!docs_src/only_py310/tutorial001_py310.py!}</code>
            ////</p>
            <p>/////</p>
            """
        )
